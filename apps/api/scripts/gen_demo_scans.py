...
# ---------------------------------------------------------------------------
RNG = random.Random(20260623)  # noqa: S311 — deterministic demo data, not crypto
...
NPM_CVES: list[tuple] = [
    ...
    (
        ...
        7.5,
        "High",
        "ReDoS in semver via the new Range function",
        ["CWE-1333"],
        False,
    ),
    (
        ...
        7.5,
        "High",
        "qs vulnerable to Prototype Pollution via express",
        ["CWE-1321"],
        False,
    ),
    (
        ...
        7.5,
        "High",
        "Path Traversal in moment locale loading",
        ["CWE-22"],
        False,
    ),
    (
    ...
    (
        ...
        6.5,
        "Medium",
        "axios XSRF token sent in cross-site requests",
        ["CWE-352"],
        False,
    ),
    (
        ...
        7.5,
        "High",
        "Regular Expression Denial of Service in cross-spawn",
        ["CWE-1333"],
        False,
    ),
    (
    ...
    (
        ...
        7.5,
        "High",
        "Forgeable RSA-PSS signatures in jsrsasign",
        ["CWE-347"],
        False,
    ),
    (
        ...
        6.5,
        "Medium",
        "follow-redirects leaks Authorization header on cross-origin",
        ["CWE-200"],
        False,
    ),
    (
        ...
        7.4,
        "High",
        "Webpack's AutoPublicPathRuntimeModule can lead to XSS",
        ["CWE-79"],
        False,
    ),
    (
        ...
        7.5,
        "High",
        "path-to-regexp ReDoS via backtracking",
        ["CWE-1333"],
        False,
    ),
    (
        ...
        6.5,
        "Medium",
        "cookie accepts cookie name/path/domain with out of bounds chars",
        ["CWE-74"],
        False,
    ),
    (
        ...
        9.8,
        "Critical",
        "ip SSRF (legacy) via IPv4-mapped IPv6 address bypass",
        ["CWE-918"],
        False,
    ),
    (
    ...
    (
        ...
        7.5,
        "High",
        "axios SSRF via path-relative URL handling",
        ["CWE-918"],
        False,
    ),
    (
        ...
        9.8,
        "Critical",
        "Webpack cross-realm object access in ImportParserPlugin",
        ["CWE-1321"],
        False,
    ),
    (
        ...
        6.8,
        "Medium",
        "undici fetch leaks Authorization on cross-origin redirect",
        ["CWE-200"],
        False,
    ),
    (
        ...
        6.1,
        "Medium",
        "request library SSRF in HTTP redirect handling",
        ["CWE-918"],
        False,
    ),
    (
    ...
    (
        ...
        5.3,
        "Medium",
        "AngularJS Regular Expression Denial of Service",
        ["CWE-1333"],
        False,
    ),
]
...
PYPI_CVES: list[tuple] = [
    ...
    (
        ...
        5.4,
        "Medium",
        "Jinja2 vulnerable to HTML attribute injection via xmlattr",
        ["CWE-79"],
        False,
    ),
    (
        ...
        6.2,
        "Medium",
        "idna denial of service via crafted input",
        ["CWE-400"],
        False,
    ),
    (
        ...
        7.5,
        "High",
        "Flask session cookie may persist across requests",
        ["CWE-200"],
        False,
    ),
    (
        ...
        5.6,
        "Medium",
        "Requests reuses TLS context after verify=False",
        ["CWE-670"],
        False,
    ),
    (
        ...
        7.5,
        "High",
        "certifi removed e-Tugra root certificates",
        ["CWE-345"],
        False,
    ),
    (
        ...
        8.1,
        "High",
        "urllib3 cookie request header isn't stripped on cross-origin redirect",
        ["CWE-200"],
        False,
    ),
    (
        ...
        4.4,
        "Medium",
        "urllib3 Proxy-Authorization request header isn't stripped",
        ["CWE-200"],
        False,
    ),
    (
    ...
    (
        ...
        5.5,
        "Medium",
        "Pillow buffer overflow in _imagingcms.c",
        ["CWE-120"],
        False,
    ),
    (
        ...
        7.5,
        "High",
        "Pydantic regex ReDoS in email validator",
        ["CWE-1333"],
        False,
    ),
    (
        ...
        9.8,
        "Critical",
        "certifi removed e-Tugra root from the root store",
        ["CWE-345"],
        False,
    ),
    (
        ...
        7.5,
        "High",
        "cryptography NULL pointer dereference in PKCS12",
        ["CWE-476"],
        False,
    ),
    (
        ...
        7.5,
        "High",
        "Gunicorn HTTP request smuggling via Transfer-Encoding",
        ["CWE-444"],
        False,
    ),
    (
        ...
        5.4,
        "Medium",
        "Jinja2 xmlattr filter accepts keys with non-attribute chars",
        ["CWE-79"],
        False,
    ),
    (
        ...
        7.5,
        "High",
        "Werkzeug resource exhaustion in multipart parsing",
        ["CWE-770"],
        False,
    ),
    (
        ...
        5.3,
        "Medium",
        "FastAPI ReDoS via Content-Type header parsing",
        ["CWE-1333"],
        False,
    ),
    (
        ...
        6.1,
        "Medium",
        "lxml html clean allows XSS via crafted SVG",
        ["CWE-79"],
        False,
    ),
    (
        ...
        5.3,
        "Medium",
        "requests netrc credentials leak via URL parsing",
        ["CWE-200"],
        False,
    ),
    (
        ...
        7.5,
        "High",
        "Eventlet DNS rebinding via dnspython",
        ["CWE-918"],
        False,
    ),
    (
        ...
        5.5,
        "Medium",
        "Ansible template injection in jinja2 filters",
        ["CWE-94"],
        False,
    ),
    (
        ...
        5.3,
        "Medium",
        "black formatter ReDoS in input parsing",
        ["CWE-1333"],
        False,
    ),
    (
        ...
        7.5,
        "High",
        "cryptography NULL pointer deref when loading PKCS7 cert",
        ["CWE-476"],
        False,
    ),
    (
        ...
        8.8,
        "High",
        "setuptools remote code execution via download functions",
        ["CWE-94"],
        False,
    ),
]
...
JAVA_CVES: list[tuple] = [
    (
        ...
        10.0,
        "Critical",
        "Log4Shell — Apache Log4j2 JNDI RCE",
        ["CWE-502", "CWE-917"],
        True,
    ),
    (
        ...
        9.0,
        "Critical",
        "Log4j 2.15.0 incomplete fix — JNDI lookup RCE",
        ["CWE-502", "CWE-917"],
        True,
    ),
    (
        ...
        9.8,
        "Critical",
        "Spring4Shell — Spring Framework JDK 9+ RCE",
        ["CWE-94"],
        True,
    ),
    (
    ...
    (
        ...
        10.0,
        "Critical",
        "Equifax — Struts2 Jakarta Multipart parser RCE",
        ["CWE-20"],
        True,
    ),
    (
        ...
        9.8,
        "Critical",
        "Log4j 1.x SocketServer deserialization RCE",
        ["CWE-502"],
        False,
    ),
    (
        ...
        7.5,
        "High",
        "Jackson deep wrapper array nesting DoS",
        ["CWE-502"],
        False,
    ),
    (
        ...
        7.5,
        "High",
        "Jackson Java StackOverflow in nested objects",
        ["CWE-787"],
        False,
    ),
    (
        ...
        8.8,
        "High",
        "Spring Framework ** path matching mismatch",
        ["CWE-22"],
        False,
    ),
    (
    ...
    (
        ...
        7.5,
        "High",
        "Spring WebMVC path traversal via static resource handling",
        ["CWE-22"],
        False,
    ),
    (
        ...
        7.5,
        "High",
        "Spring WebFlux path traversal in functional web framework",
        ["CWE-22"],
        False,
    ),
    (
        ...
        8.1,
        "High",
        "Spring Framework URI parsing open redirect / SSRF",
        ["CWE-601"],
        False,
    ),
    (
        ...
        8.0,
        "High",
        "PostgreSQL JDBC driver SQL injection in ResultSet",
        ["CWE-89"],
        False,
    ),
    (
        ...
        7.5,
        "High",
        "Tomcat HTTP/2 request smuggling",
        ["CWE-444"],
        False,
    ),
    (
        ...
        7.5,
        "High",
        "Tomcat HTTP/2 DoS via excessive memory",
        ["CWE-770"],
        False,
    ),
    (
        ...
        6.5,
        "Medium",
        "Tomcat WebSocket DoS via unclosed connections",
        ["CWE-404"],
        False,
    ),
    (
        ...
        7.5,
        "High",
        "HTTP/2 Rapid Reset attack — netty",
        ["CWE-400"],
        True,
    ),
    (
        ...
        5.3,
        "Medium",
        "Netty allocation of resources without limits",
        ["CWE-770"],
        False,
    ),
    (
        ...
        9.8,
        "Critical",
        "XStream remote code execution via crafted XML",
        ["CWE-502"],
        False,
    ),
    (
        ...
        7.4,
        "High",
        "Spring Framework open redirect via UriComponentsBuilder",
        ["CWE-601"],
        False,
    ),
    (
        ...
        7.4,
        "High",
        "Spring Framework SSRF via UriComponentsBuilder",
        ["CWE-918"],
        False,
    ),
    (
        ...
        6.5,
        "Medium",
        "Spring Expression DoS via crafted SpEL expression",
        ["CWE-770"],
        False,
    ),
]
...
OS_CVES: list[tuple] = [
    ...
    (
        ...
        7.5,
        "High",
        "OpenSSL infinite loop in BN_mod_sqrt parsing certs",
        ["CWE-835"],
        False,
    ),
    (
    ...
    (
        ...
        7.5,
        "High",
        "OpenSSL excessive resource use in X.509 policy verification",
        ["CWE-770"],
        False,
    ),
    (
        ...
        5.5,
        "Medium",
        "OpenSSL NULL pointer dereference in PKCS12 decoding",
        ["CWE-476"],
        False,
    ),
    (
        ...
        7.5,
        "High",
        "OpenSSL incorrect cipher key/IV length handling",
        ["CWE-326"],
        False,
    ),
    (
    ...
    (
        ...
        7.8,
        "High",
        "Looney Tunables — glibc ld.so GLIBC_TUNABLES buffer overflow",
        ["CWE-122"],
        True,
    ),
    (
        ...
        7.3,
        "High",
        "glibc iconv ISO-2022-CN-EXT buffer overflow",
        ["CWE-122"],
        False,
    ),
    (
        ...
        7.8,
        "High",
        "glibc __vsyslog_internal heap buffer overflow",
        ["CWE-122"],
        False,
    ),
    (
        ...
        7.5,
        "High",
        "glibc nscd netgroup cache stack overflow",
        ["CWE-121"],
        False,
    ),
    (
    ...
    (
        ...
        8.1,
        "High",
        "regreSSHion — OpenSSH sshd signal handler race RCE",
        ["CWE-364"],
        True,
    ),
    (
        ...
        5.9,
        "Medium",
        "Terrapin — SSH transport protocol prefix truncation",
        ["CWE-222"],
        False,
    ),
    (
        ...
        5.3,
        "Medium",
        "OpenSSH ObscureKeystrokeTiming bypass",
        ["CWE-208"],
        False,
    ),
    # bash / shell
    ...
    (
        ...
        7.8,
        "High",
        "sudoedit arbitrary file edit via EDITOR env arg injection",
        ["CWE-269"],
        True,
    ),
    (
    ...
    (
        ...
        8.8,
        "High",
        "BusyBox netstat allows ANSI escape sequence injection",
        ["CWE-1289"],
        False,
    ),
    (
    ...
    (
        ...
        5.5,
        "Medium",
        "BusyBox awk use-after-free in copyvar",
        ["CWE-416"],
        False,
    ),
    # xz / liblzma
    (
        ...
        10.0,
        "Critical",
        "xz-utils backdoor in liblzma compromising sshd",
        ["CWE-506"],
        True,
    ),
    # Apache HTTPD
    (
        ...
        7.5,
        "High",
        "Apache HTTP Server path traversal in mod_alias",
        ["CWE-22"],
        True,
    ),
    (
    ...
    (
        ...
        9.8,
        "Critical",
        "Apache HTTP Server mod_proxy request smuggling",
        ["CWE-444"],
        False,
    ),
    (
        ...
        8.1,
        "High",
        "Apache HTTP Server encoded URL bypass via mod_rewrite",
        ["CWE-863"],
        False,
    ),
    (
        ...
        8.1,
        "High",
        "Apache HTTP Server substitution bypass via mod_rewrite",
        ["CWE-22"],
        False,
    ),
    (
        ...
        5.3,
        "Medium",
        "Apache HTTP Server source code disclosure via AddType",
        ["CWE-200"],
        False,
    ),
    # nginx
    (
        ...
        7.8,
        "High",
        "nginx ngx_http_mp4_module memory corruption",
        ["CWE-787"],
        False,
    ),
    (
        ...
        7.8,
        "High",
        "nginx ngx_http_mp4_module memory disclosure",
        ["CWE-125"],
        False,
    ),
    (
        ...
        4.7,
        "Medium",
        "nginx ngx_http_mp4_module out-of-bounds read",
        ["CWE-125"],
        False,
    ),
    # SMB / Windows
    (
        ...
        8.1,
        "High",
        "EternalBlue — Windows SMBv1 remote code execution",
        ["CWE-20"],
        True,
    ),
    (
        ...
        10.0,
        "Critical",
        "SMBGhost — Windows SMBv3 compression RCE",
        ["CWE-119"],
        True,
    ),
    (
        ...
        10.0,
        "Critical",
        "Zerologon — Windows Netlogon elevation of privilege",
        ["CWE-330"],
        True,
    ),
    (
    ...
    (
        ...
        7.8,
        "High",
        "Follina — Windows MSDT remote code execution",
        ["CWE-22"],
        True,
    ),
    (
        ...
        9.8,
        "Critical",
        "Microsoft Outlook elevation of privilege via NTLM hash leak",
        ["CWE-294"],
        True,
    ),
    ...
    (
        ...
        9.1,
        "Critical",
        "Atlassian Confluence improper authorization data exfiltration",
        ["CWE-863"],
        True,
    ),
    # MOVEit, GitLab, MinIO
    (
        ...
        9.8,
        "Critical",
        "MOVEit Transfer SQL injection — Clop ransomware exploitation",
        ["CWE-89"],
        True,
    ),
    (
        ...
        9.9,
        "Critical",
        "GitLab arbitrary file write via workspace creation",
        ["CWE-22"],
        False,
    ),
    (
        ...
        9.8,
        "Critical",
        "MinIO information disclosure via signature exploit",
        ["CWE-200"],
        False,
    ),
    # PHP
    ...
    (
        ...
        5.3,
        "Medium",
        "PHP cookie filter bypass via __Host- and __Secure- prefixes",
        ["CWE-565"],
        False,
    ),
    (
        ...
        5.3,
        "Medium",
        "PHP password_verify bypass via null bytes",
        ["CWE-287"],
        False,
    ),
    # MySQL / PostgreSQL
    (
        ...
        6.5,
        "Medium",
        "MySQL Server DoS via Optimizer manipulation",
        ["CWE-770"],
        False,
    ),
    (
        ...
        3.1,
        "Low",
        "PostgreSQL libpq server messages may inject control chars",
        ["CWE-93"],
        False,
    ),
    (
        ...
        4.2,
        "Medium",
        "PostgreSQL row security incorrectly applied to subqueries",
        ["CWE-863"],
        False,
    ),
    # runc / containerd
    (
        ...
        8.6,
        "High",
        "Leaky Vessels — runc file descriptor leak container escape",
        ["CWE-403"],
        False,
    ),
    (
        ...
        8.7,
        "High",
        "BuildKit race condition with mount cache during build",
        ["CWE-362"],
        False,
    ),
    (
        ...
        9.1,
        "Critical",
        "BuildKit arbitrary file deletion outside container root",
        ["CWE-22"],
        False,
    ),
    (
        ...
        9.8,
        "Critical",
        "BuildKit interactive containers API privilege escalation",
        ["CWE-269"],
        False,
    ),
    # Kubernetes / Helm
    ...
    (
        ...
        6.1,
        "Medium",
        "Kubernetes Windows nodes incorrect default file permissions",
        ["CWE-276"],
        False,
    ),
    # Misc network
    ...
    (
        ...
        9.1,
        "Critical",
        "Ivanti Connect Secure command injection in web components",
        ["CWE-77"],
        True,
    ),
    (
    ...
    (
        ...
        8.2,
        "High",
        "Ivanti Connect Secure authentication bypass in web components",
        ["CWE-287"],
        True,
    ),
    (
        ...
        9.8,
        "Critical",
        "FortiManager missing authentication for critical API endpoint",
        ["CWE-306"],
        True,
    ),
    (
    ...
    (
        ...
        10.0,
        "Critical",
        "GitLab account takeover via password reset to arbitrary email",
        ["CWE-640"],
        True,
    ),
]
...
WEB_CWE_FINDINGS: list[tuple] = [
    ...
    (
        ...
        "User input reflected into HTML response without encoding",
    ),
    (
        "CWE-79",
        "A03:2021-Injection",
        ...
        "User input persisted and rendered to other users without sanitization",
    ),
    (
        "CWE-89",
        "A03:2021-Injection",
    ...
    (
        ...
        7.5,
        "Path Traversal",
        "Application allows access to files outside the intended directory",
    ),
    (
        "CWE-352",
        "A01:2021-Broken Access Control",
        ...
        "State-changing endpoint lacks anti-CSRF token",
    ),
    (
        "CWE-798",
        ...
        "Hardcoded API token / password in source code",
    ),
    (
        "CWE-327",
        ...
        "High",
        7.5,
        "Use of Broken or Weak Crypto",
        "Application uses MD5/SHA-1/DES for security-sensitive operations",
    ),
    (
        "CWE-330",
        "A02:2021-Cryptographic Failures",
        ...
        "Use of java.util.Random for security tokens",
    ),
    (
        "CWE-918",
        "A10:2021-SSRF",
        ...
        "User-supplied URL fetched server-side without validation",
    ),
    (
        "CWE-611",
    ...
    (
        ...
        "Object deserialization on user-controlled input",
    ),
    (
        "CWE-601",
        "A01:2021-Broken Access Control",
        ...
        6.1,
        "Open Redirect",
        "User-controlled URL used in redirect without allowlist",
    ),
    (
        "CWE-862",
        "A01:2021-Broken Access Control",
        ...
        "Sensitive endpoint accessible without authorization check",
    ),
    (
        "CWE-863",
        "A01:2021-Broken Access Control",
        ...
        "Authorization check present but logic incorrect",
    ),
    (
        "CWE-200",
        ...
        "Sensitive data leaked in error message or response header",
    ),
    (
        "CWE-770",
        "A04:2021-Insecure Design",
        ...
        "Endpoint lacks rate limiting or request size limits",
    ),
    (
        "CWE-79",
        "A03:2021-Injection",
        ...
        "Client-side script writes user input to DOM via dangerous sink",
    ),
    (
        "CWE-565",
        "A04:2021-Insecure Design",
        "Medium",
        5.3,
        "Reliance on Untrusted Cookie",
        "Authorization decisions based on cookies without integrity check",
    ),
    (
        "CWE-117",
        ...
        "User input written to logs without sanitization (log forging)",
    ),
    (
        "CWE-326",
        "A02:2021-Cryptographic Failures",
        ...
        "Use of <2048-bit RSA / <128-bit symmetric keys",
    ),
    (
        "CWE-1004",
        "A05:2021-Security Misconfiguration",
    ...
    (
        ...
        "Session cookie sent over unencrypted channel",
    ),
    (
        "CWE-732",
        "A05:2021-Security Misconfiguration",
        ...
        "World-readable / world-writable file permissions on sensitive file",
    ),
    (
        "CWE-94",
        "A03:2021-Injection",
        ...
        9.8,
        "Code Injection",
        "User input evaluated as code (eval, Function constructor)",
    ),
]
...
HOSTNAMES = [
    ...
    "web-prod-02.corp.example.com",
    "api-gateway-01.corp.example.com",
    "api-gateway-02.corp.example.com",
    "db-postgres-primary.corp.example.com",
    "db-postgres-replica-01.corp.example.com",
    "db-mysql-primary.corp.example.com",
    "redis-cache-01.corp.example.com",
    "redis-cache-02.corp.example.com",
    "kafka-broker-01.corp.example.com",
    "kafka-broker-02.corp.example.com",
    "kafka-broker-03.corp.example.com",
    "es-data-01.corp.example.com",
    "es-data-02.corp.example.com",
    "es-master-01.corp.example.com",
    "jenkins-ci.corp.example.com",
    "gitlab-runner-01.corp.example.com",
    "gitlab-runner-02.corp.example.com",
    "vault-prod.corp.example.com",
    "consul-prod-01.corp.example.com",
    "monitoring-prom.corp.example.com",
    "monitoring-grafana.corp.example.com",
    "logging-elk.corp.example.com",
    "bastion-01.corp.example.com",
    "vpn-gateway-01.corp.example.com",
    "vpn-gateway-02.corp.example.com",
    "auth-keycloak.corp.example.com",
    "smtp-relay.corp.example.com",
    "dev-workstation-042.corp.example.com",
    "dev-workstation-118.corp.example.com",
    "qa-runner-01.corp.example.com",
    "qa-runner-02.corp.example.com",
    "build-mac-mini-01.corp.example.com",
    "file-share-01.corp.example.com",
    "domain-controller-01.corp.example.com",
    "domain-controller-02.corp.example.com",
    "exchange-mailbox-01.corp.example.com",
    "sharepoint-prod.corp.example.com",
    "rdp-jumpbox-01.corp.example.com",
    "k8s-master-01.corp.example.com",
    "k8s-master-02.corp.example.com",
    "k8s-worker-12.corp.example.com",
    "k8s-worker-17.corp.example.com",
    "k8s-worker-23.corp.example.com",
    "k8s-worker-31.corp.example.com",
    "k8s-worker-44.corp.example.com",
    "edge-cdn-01.corp.example.com",
    "edge-cdn-02.corp.example.com",
    "backup-nfs-01.corp.example.com",
    "ad-fs-01.corp.example.com",
...
CONTAINER_IMAGES = [
    ...
    (
        "debian",
        "11-slim",
        "sha256:11e26e1aef38d75c5a4ed8d6a906b14ee49da1c5e2c6e5fa78a87b3a51dd2f5e",
    ),
    (
        "debian",
        "12-slim",
        "sha256:bc89e425f1ec1c20ec3cce0d8edabd0e7d8c52196e9c8eecda1ac8e7c0ff5b4d",
    ),
    ...
    (
        "python",
        "3.11-slim",
        "sha256:9a8c4f7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e",
    ),
    (
        "python",
        "3.12-alpine",
        "sha256:abc4f7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e",
    ),
    ...
    (
        "nginx",
        "1.25-alpine",
        "sha256:5678f7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e",
    ),
    ("nginx", "1.27", "sha256:91abf7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e"),
    (
        "postgres",
        "15-alpine",
        "sha256:fedcf7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e",
    ),
    (
        "postgres",
        "16-alpine",
        "sha256:cafef7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e",
    ),
    ("redis", "7-alpine", "sha256:beeff7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e"),
    (
        "internal/checkout-svc",
        "v2.14.3",
        "sha256:aaaaaaa7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e",
    ),
    (
        "internal/checkout-svc",
        "v2.14.4",
        "sha256:bbbbbbb7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e",
    ),
    (
        "internal/payments-api",
        "v1.8.0",
        "sha256:ccccccc7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e",
    ),
    (
        "internal/orders-worker",
        "v3.2.1",
        "sha256:ddddddd7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e",
    ),
    (
        "internal/auth-svc",
        "v4.1.7",
        "sha256:eeeeeee7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e7e",
    ),
]
        ...
        findings.append(
            {
                ...
                "plugin": {
                    ...
                    if kev
                    else "No known exploits are available",
...
def gen_qualys_vuln(n: int) -> dict:
        ...
        findings.append(
            {
                ...
                "BUGTRAQ_LIST": {"BUGTRAQ": [str(RNG.randint(20000, 99999))]}
                if RNG.random() < 0.3
                else {},
                ...
                "EXPLOIT": {"SRC": [{"NAME": "Metasploit", "DESC": "Module available"}]}
                if kev
                else {},
                "HOST": {
                    "IP": _ip_for(host),
    ...
    return {
        "ASSET_DATA_REPORT": {
            ...
            "RISK_SCORE_SUMMARY": {
                "AVG_SECURITY_RISK": str(
                    round(sum(float(f["CVSS3_BASE"]) for f in findings) / max(1, len(findings)), 2)
                )
            },
...
def _grype_ecosystem(image_name: str):
    ...
    if "alpine" in image_name:
        return "apk", "alpine"
    if (
        "debian" in image_name
        or "ubuntu" in image_name
        or "nginx" in image_name
        or "postgres" in image_name
        or "redis" in image_name
    ):
        return "deb", "debian"
...
def gen_grype(n: int) -> dict:
        ...
        matches.append(
            {
                "vulnerability": {
                    ...
                    "namespace": "nvd:cpe"
                    if not artifact_type == "apk"
                    else "alpine:distro:alpine:3.18",
                    "severity": sev,
                    ...
                    "cvss": [
                        {
                            ...
                            "metrics": {
                                "baseScore": cvss,
                                "exploitabilityScore": round(RNG.uniform(2.0, 3.9), 1),
                                "impactScore": round(RNG.uniform(3.0, 5.9), 1),
                            },
                        }
                    ],
                    "fix": {
                        "versions": [fixed_v] if fixed_v else [],
                        "state": "fixed" if fixed_v else "unknown",
                    },
                    "advisories": [],
                },
                ...
                "matchDetails": [
                    {
                        ...
                        "searchedBy": {
                            "distro": {"type": distro, "version": "3.18"}
                            if artifact_type == "apk"
                            else None,
                            "namespace": "nvd:cpe",
                            "package": {"name": pkg, "version": vuln_v},
                        },
                        "found": {
                            "versionConstraint": f"< {fixed_v or 'unknown'} ({artifact_type})",
                            "vulnerabilityID": cve_to_use,
                        },
                    }
                ],
                "artifact": {
                    ...
                    "locations": [
                        {
                            "path": f"/usr/lib/{pkg}/{vuln_v}/"
                            if artifact_type in ("apk", "deb")
                            else f"/app/node_modules/{pkg}/package.json"
                        }
                    ],
                    "language": {"npm": "javascript", "pypi": "python"}.get(artifact_type, ""),
                    "licenses": ["MIT"] if artifact_type in ("npm", "pypi") else ["GPL-2.0-only"],
                    "cpes": [
                        f"cpe:2.3:a:{pkg.split('/')[-1]}:{pkg.split('/')[-1]}:{vuln_v}:*:*:*:*:*:*:*"
                    ],
                    "purl": purl,
    ...
    distinct_images = list(
        {(n, t, d) for (n, t, d) in [RNG.choice(CONTAINER_IMAGES) for _ in range(min(n, 12))]}
    )
                ...
                "layers": [
                    {
                        ...
                        "digest": primary_image[2],
                        "size": RNG.randint(10_000_000, 200_000_000),
                    }
                ],
            },
        },
        ...
        vulns.append(
            {
                ...
                "cvssDetails": [
                    {
                        "assigner": "Snyk",
                        "severity": sev.lower(),
                        "cvssV3Vector": cvss_vector_for(cvss),
                        "cvssV3BaseScore": cvss,
                        "modificationTime": iso(90),
                    }
                ],
                ...
                "epssDetails": {
                    "percentile": str(round(RNG.uniform(0.10, 0.99), 5)),
                    "probability": str(round(RNG.uniform(0.0001, 0.4), 5)),
                    "modelVersion": "v2024.04.23",
                },
                "identifiers": {
                    "CVE": [cve_to_use],
                    "CWE": cwes,
                    "GHSA": [
                        f"GHSA-{''.join(RNG.choices('abcdefghijklmnop', k=4))}-{''.join(RNG.choices('abcdefghijklmnop', k=4))}-{''.join(RNG.choices('abcdefghijklmnop', k=4))}"
                    ],
                },
...
def gen_sonarqube(n: int) -> dict:
    ...
    for _i in range(n):
        ...
        sev = severity_weighted_choice()
        sonar_sev = {"Critical": "BLOCKER", "High": "CRITICAL", "Medium": "MAJOR", "Low": "MINOR"}[
            sev
        ]
        ...
        file_path = RNG.choice(
            [
                ...
                if f.endswith(("." + lang) if lang != "ts" else ".tsx")
                or (lang == "js" and f.endswith((".js", ".jsx")))
                or (lang == "ts" and f.endswith((".ts", ".tsx")))
                or (lang == "py" and f.endswith(".py"))
                or (lang == "java" and f.endswith(".java"))
                or (lang == "cs" and f.endswith(".cs"))
            ]
            or SONAR_FILES
        )
        ...
        issues.append(
            {
                ...
                "textRange": {
                    "startLine": (sl := RNG.randint(15, 480)),
                    "endLine": sl,
                    "startOffset": RNG.randint(0, 40),
                    "endOffset": RNG.randint(40, 120),
                },
                "flows": [],
                "status": "OPEN",
                ...
                "author": RNG.choice(
                    [
                        ...
                        "charlie.lee@acmecorp.com",
                        "priya.patel@acmecorp.com",
                    ]
                ),
...
BURP_PATHS = [
    ...
    "/assets/uploads/{file}",
    "/api/v2/graphql",
    "/api/v1/webhook/payment-callback",
    "/api/v1/files/upload",
    "/forgot-password",
    "/reset-password",
    "/oauth/callback",
...
def gen_burp(n: int) -> dict:
    ...
    for _ in range(n):
        ...
        path = (
            RNG.choice(BURP_PATHS)
            .replace("{id}", str(RNG.randint(1, 99999)))
            .replace("{file}", f"file_{RNG.randint(1, 9999)}.pdf")
        )
        ...
        issue_events.append(
            {
                "issue": {
                    ...
                    "issue_background": desc
                    + ". Such vulnerabilities are commonly exploited to compromise user accounts, steal session data, or pivot deeper into the application.",
        ...
        "issue_definitions": [
            {
                "type_index": idx,
                "name": name,
                "description": f"Issue definition for {name}.",
                "remediation": "Apply context-appropriate fixes.",
            }
            for name, idx in issue_defs_seen.items()
        ],
    }
